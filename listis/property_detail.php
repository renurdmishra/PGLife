...
$sql_4 = "SELECT * FROM interested_users_property WHERE property_id = '$property_id'";
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list.php?city=<?= $property['city_name']; ?>"></a>
            </li>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    ...
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['rating_safty'] ?>">
                            <?php
                            $rating = $property['rating_safty'];
                            for ($i = 0; $i < 5; $i++) {
                                if ($rating >= $i + 0.8) {
                            ?>
                                    <i class="fas fa-star"></i>
